...
import fetch from "node-fetch"; // IMPORTANT: prevents "fetch is not defined" on Render
...
// Use this string to confirm your newest deploy is live
app.get("/", (req, res) => res.status(200).send("alive-v3-dob-normalize"));
